...
### 19. `uc_sync_state` is unreadable: SUCCESS/FAILURE only + `error_message` overloaded — **FIXED (pending live validation)** (2026-09-13)
...
### 18. Incremental masks prior failures — an object that FAILED is skipped as UNCHANGED→SUCCESS — **FIXED (pending live validation)** (2026-09-13)
...
### 17. FEAT-4 volume-file copy results are absent from the migration report — **FIXED (pending live validation)** (2026-09-13)
