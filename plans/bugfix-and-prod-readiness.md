...
### 12. Skipped objects are labeled "SUCCESS," which inflates the numbers — **OPEN** (absorbed by FEAT-5)
...
### FEAT-1. Run everything through one SQL warehouse (drop the dual-compute split) — **PROPOSED**
...
### FEAT-2. Create governed tags before applying them — **PROPOSED**
...
### FEAT-3. Governed schema-evolution — replay new source columns + their governance — **PROPOSED**
...
### FEAT-4. Copy volume data (files) source → target — **PROPOSED**
...
### FEAT-5. Match the workspace-migration (wsmig) report format — **PROPOSED** (absorbs #12)
