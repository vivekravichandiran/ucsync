...
3. **Test approach:** `test_state_status_vocabulary_and_message_split`, `test_unchanged_action_reads_as_skipped_not_created`, updated `test_full_run_seeds_then_unchanged_rerun_is_zero_writes` (295 green). Live re-validation of the state table + report.
